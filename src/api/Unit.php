 ...
 */
interface Unit extends \UnitEnum {
	/**
	 ...
	 * При передаче в метод экземпляра текущего перечисления в качестве аргумента, вариант,
	 * соответствующий экземпляру перечисления становится главным. В этом случае метод вернет
	 * экземпляр перечисления для предыдущего главного варианта, либо значение по умолчанию,
	 * если главный вариант ранее не был установлен.
	 */
	 ...
	 * При вызове с одним истинным аргументом (любое значение возвращающее TRUE) сделать вариант
